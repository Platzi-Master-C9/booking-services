	...
	body: {
		...
		properties: {
			...
			address: {
				...
				required: ['country', 'state', 'city', 'zipcode', 'street', 'price'],
			},
...
const validateAddressSchema = {
	description: 'This is the route to use for validate a new place',
	tags: ['Places'],
	body: {
		type: 'object',
		properties: {
		...
		required: ['country', 'state', 'city', 'zipcode', 'street'],
	},
};
