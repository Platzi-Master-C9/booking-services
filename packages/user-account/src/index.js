...
const { createBookmarkSchema } = require('./utils/validator/schema/bookmark.schema');
...
module.exports = {
  ...
  createBookmark: validatorHandler.bind(null, bookmarkService.createBookmark, models, createBookmarkSchema),
};
