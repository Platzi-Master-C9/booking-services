...
export const collections: { notifications?: mongoDB.Collection<Notification> } = {};
...
export async function connectToDatabase() {
    ...
    const gamesCollection = db.collection<Notification>(process.env.GAMES_COLLECTION_NAME);

    // Persist the connection to the Games collection
    collections.notifications = gamesCollection;
